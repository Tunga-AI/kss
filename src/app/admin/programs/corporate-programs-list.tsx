...
export default function AdminCorporateProgramsPage() {
    ...
    const filteredPrograms = useMemo(() => {
        ...
        return allPrograms.filter(p => {
            if (p.programType !== 'Corporate') return false; // Only Corporate
            ...
            <div className="w-full">
                ...
                <div className="bg-primary text-white p-6 mb-6 border-b border-primary/10 rounded-tl-3xl rounded-br-3xl rounded-tr-none rounded-bl-none shadow-2xl relative overflow-hidden">
                    ...
                    <div className="relative z-10 flex flex-col md:flex-row justify-between items-center gap-6">
                        <div>
                            <h1 className="text-3xl sm:text-4xl font-bold mb-2 tracking-tight">Corporate Programs</h1>
                            <p className="text-white/80 text-lg font-medium">Manage private corporate cohorts and programs</p>
                        </div>
                        <div className="flex items-center gap-3">
                            <Button asChild className="bg-secondary hover:bg-secondary/90 text-white border-none h-12 px-6 rounded-tl-xl rounded-br-xl font-bold shadow-lg transition-all">
                                <Link href="/a/programs/new?type=corporate">
                ...
                <div className="flex flex-col lg:flex-row gap-4 mb-6 items-end">
                    <div className="relative flex-1 group w-full">
                        ...
                        <div className="relative">
                            ...
                            <Input
                                placeholder="Search private corporate programs..."
                                className="pl-12 h-14 bg-white border-primary/10 rounded-tl-xl rounded-br-xl focus:ring-primary focus:border-primary shadow-sm text-base font-medium"
                                value={searchQuery}
