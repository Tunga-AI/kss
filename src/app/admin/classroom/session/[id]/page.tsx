...
import { ArrowLeft, Video, UploadCloud, Users, Settings } from 'lucide-react';
        ...
        <div className="grid gap-6">
            <div className="flex items-center justify-between gap-4">
                <div className="flex items-center gap-4">
                 ...
                 <Button asChild>
                    <Link href={`/a/classroom/${id}`}>
                        <Settings className="mr-2" /> Edit Session
                    </Link>
                </Button>
            </div>
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>This is where the live video session will take place. As an admin, you have full session controls.</CardDescription>
                </CardHeader>
                <CardContent>
             ...
             <div className="grid md:grid-cols-2 gap-6">
                <Card>
                    ...
                    <CardContent>
                        <p className="text-muted-foreground">Upload and manage materials for this session.</p>
                        <Button className="mt-4">Upload Material</Button>
                    </CardContent>
                </Card>
                <Card>
                    <CardHeader>
