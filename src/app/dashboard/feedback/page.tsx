...
import { RefreshCw, MessageSquare, Calendar, CheckCircle, Search, ChevronDown, Clock, ArrowRight, Filter } from "lucide-react";
      ...
      <div className="w-full">
        ...
        <div className="bg-primary text-white p-6 mb-6 border-b border-primary/10 rounded-tl-3xl rounded-br-3xl rounded-tr-none rounded-bl-none shadow-2xl relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <p className="text-white/80 text-lg font-medium">Share your thoughts to help us improve your learning experience</p>
          </div>
        </div>
